(function () {
  ...
  var dishes = {
    ...
    hotdog: {
      num: '02', tag: 'Double stacked', name: 'Double Pattied Cheeseburger', priceNum: 15, category: 'burgers',
      short: 'Double smash patties, melted cheese, all the fixings',
      desc: 'Two thick, juicy beef patties stacked high with melted American cheese, fresh lettuce, ripe tomato, pickles and our signature sauce on a toasted sesame bun.',
      calories: '920', spice: 'Mild', prep: '14′',
      ingredients: ['Sesame bun', 'Beef patty ×2', 'American cheese ×2', 'Lettuce', 'Tomato', 'Pickles', 'Signature sauce'],
      allergens: ['Gluten', 'Dairy', 'Sesame'],
      rating: '4.7', reviewCount: '156',
      reviews: [
        { q: '”Double the patties, double the joy.”', a: 'Priya N.' },
        { q: '”This is what a real cheeseburger should be.”', a: 'Cole B.' }
      ],
      model: 'models/double pattied cheeseburger.glb'
    },
    parma: {
  ...
  function setupLighting(THREE, scene) {
    ...
    scene.add(new THREE.HemisphereLight(0xffffff, 0x8c8c8c, 0.5));
  ...
  function setupEnvironment(THREE, scene, renderer) {
    ...
    var envKey = new THREE.DirectionalLight(0xffffff, 0.6);
    envKey.position.set(5, 10, 7);
    envScene.add(envKey);
    var envFill = new THREE.DirectionalLight(0xffffff, 0.3);
